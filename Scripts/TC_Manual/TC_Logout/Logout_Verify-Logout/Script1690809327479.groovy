...
WebUI.callTestCase(findTestCase('TC_Manual/TC_Logout/Logout_Click-Logout-Button'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Login/Login_toggle-menu-Login'), 15)
