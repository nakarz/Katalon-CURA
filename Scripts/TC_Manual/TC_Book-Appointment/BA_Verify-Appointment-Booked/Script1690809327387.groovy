...
WebUI.callTestCase(findTestCase('TC_Manual/TC_Book-Appointment/BA_Click-BA-Button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Object Spy Manual/Book Appointment/BA_h2-Appointment Confirmation'), 15)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Book Appointment/BA_h2-Appointment Confirmation'), 15)

WebUI.waitForElementPresent(findTestObject('Object Spy Manual/Book Appointment/BA_p-info-Appointment Has Been Booked'), 
    15)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Book Appointment/BA_p-info-Appointment Has Been Booked'), 15)

WebUI.waitForElementPresent(findTestObject('Object Spy Manual/Book Appointment/BA_button-Go to Homepage'), 15)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Book Appointment/BA_button-Go to Homepage'), 15)

WebUI.click(findTestObject('Object Spy Manual/Book Appointment/BA_button-Go to Homepage'))
