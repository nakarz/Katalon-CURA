...
WebUI.callTestCase(findTestCase('TC_Manual/TC_Book-Appointment/BA_Form-Editable-False'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Spy Manual/Book Appointment/BA_button-Book Appointment'))
...
WebUI.waitForElementPresent(findTestObject('Object Spy Manual/Appontment is Booked/AisB_p-No Appointment'), 15)

WebUI.verifyElementPresent(findTestObject('Object Spy Manual/Appontment is Booked/AisB_p-No Appointment'), 15)
